...
export const seedImportedTimetabledPassingTimes: TimetabledPassingTimeInsertInput[] =
  [
    ...
    {
      vehicle_journey_id: seedVehicleJourneys[30].vehicle_journey_id,
      scheduled_stop_point_in_journey_pattern_ref_id:
    ...
    {
      vehicle_journey_id: seedVehicleJourneys[31].vehicle_journey_id,
      scheduled_stop_point_in_journey_pattern_ref_id:
    ...
    {
      vehicle_journey_id: seedVehicleJourneys[32].vehicle_journey_id,
      scheduled_stop_point_in_journey_pattern_ref_id:
    ...
    {
      vehicle_journey_id: seedVehicleJourneys[33].vehicle_journey_id,
      scheduled_stop_point_in_journey_pattern_ref_id:
        findStopIdByLabel('H2207'),
      arrival_time: Duration.fromISO('PT7H55M'),
      departure_time: Duration.fromISO('PT7H56M'),
    ...
    {
      vehicle_journey_id: seedVehicleJourneys[34].vehicle_journey_id,
      scheduled_stop_point_in_journey_pattern_ref_id:
        findStopIdByLabel('H2206'),
      arrival_time: null,
      departure_time: Duration.fromISO('PT7H48M'),
