...
const seedTimetabledPassingTimesMonFri: TimetabledPassingTimeInsertInput[] = [
  ...
  // journeys 7-19
  ...buildBulkJourneys({
    vehicleJourneyIds: [].concat(seedVehicleJourneyIds).slice(7, 20),
  ...
  ...buildBulkJourneys({
    vehicleJourneyIds: [].concat(seedVehicleJourneyIds).slice(20, 25),
    blockStartTime: Duration.fromISO('PT7H18M'),
...
const seedTimetabledPassingTimesSat: TimetabledPassingTimeInsertInput[] = [
  ...buildBulkJourneys({
    vehicleJourneyIds: [].concat(seedVehicleJourneyIds).slice(25, 29),
