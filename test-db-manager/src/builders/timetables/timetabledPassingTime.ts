...
export const defaultTimetabledPassingTimeParams: Partial<TimetabledPassingTimeSequenceBuilder> =
  {
    timetabledPassingTimeBase: {},
...
export const buildTimetabledPassingTimeSequence = (
  vehicleJourneyId: UUID,
  {
    timetabledPassingTimeBase: tptBase,
    timetabledPassingTimeSequenceBuilder: tptSequenceBuilder,
    startTime,
    stops,
    hastusStopLabels,
  }: TimetabledPassingTimeSequenceBuilder,
