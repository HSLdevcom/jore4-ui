...
export type InsertLinesMutationVariables = Exact<{
  object: Array<RouteLineInsertInput> | RouteLineInsertInput;
}>;
...
export type InsertRoutesMutationVariables = Exact<{
  object: Array<RouteRouteInsertInput> | RouteRouteInsertInput;
}>;
...
export type RemoveJourneyPatternMutationVariables = Exact<{
  journey_pattern_ids: Array<Scalars['uuid']> | Scalars['uuid'];
}>;

export type RemoveJourneyPatternMutation = {
  __typename?: 'mutation_root';
