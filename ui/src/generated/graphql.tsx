...
export type InfrastructureLinkAllFieldsFragment = { __typename?: 'infrastructure_network_infrastructure_link', infrastructure_link_id: UUID, direction: InfrastructureNetworkDirectionEnum, shape: GeoJSON.LineString, estimated_length_in_metres?: any | null | undefined, external_link_id: string, external_link_source: InfrastructureNetworkExternalSourceEnum };
