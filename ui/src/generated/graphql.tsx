...
export type VehicleJourneyWithServicesFragment = {
  __typename?: 'timetables_vehicle_journey_vehicle_journey';
  vehicle_journey_id: UUID;
  start_time: luxon.Duration;
...
`;
export const VehicleJourneyWithServicesFragmentDoc = gql`
  fragment vehicle_journey_with_services on timetables_vehicle_journey_vehicle_journey {
    vehicle_journey_id
    start_time
    end_time
    journey_pattern_ref {
...
export const GetTimetablesForOperationDayDocument = gql`
  ...
  ${VehicleJourneyWithServicesFragmentDoc}
`;
