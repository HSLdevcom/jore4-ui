...
function isRouteQueryResult(
  result: GqlQueryResult<GqlQueryResultData>,
): result is GqlQueryResult<RouteQueryResult> {
  return (result.data || false) && 'route_route' in result.data;
}
export const mapResultToRoute = (
...
export const mapResultToRoutes = (result: GqlQueryResult<RouteQueryResult>) =>
