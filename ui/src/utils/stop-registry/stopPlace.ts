...
import { StopPlaceMaintenance } from '@hsl/jore4-test-db-manager';
...
>(
  ...
  return {
    ...
    validityStart: findKeyValue(stopPlace, 'validityStart'),
    validityEnd: findKeyValue(stopPlace, 'validityEnd'),
    stopType: {
      interchange:
        stopPlace.weighting ===
