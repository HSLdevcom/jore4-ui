...
export const mapTimetablePriorityToUiName =
  genTranslationMapper<TimetablePriority>({
    ...
    [TimetablePriority.SubstituteByLineType]: (t) =>
      t(($) => $.priority.substitute),
...
>({
  ...
  [ReusableComponentsVehicleModeEnum.Bus]: (t) =>
    t(($) => $.vehicleModeEnum.bus),
  [ReusableComponentsVehicleModeEnum.Ferry]: (t) =>
    t(($) => $.vehicleModeEnum.ferry),
  [ReusableComponentsVehicleModeEnum.Metro]: (t) =>
    t(($) => $.vehicleModeEnum.metro),
  [ReusableComponentsVehicleModeEnum.Train]: (t) =>
    t(($) => $.vehicleModeEnum.train),
  [ReusableComponentsVehicleModeEnum.Tram]: (t) =>
    t(($) => $.vehicleModeEnum.tram),
});
...
export const mapStopPlaceSignTypeToUiName =
  genTranslationMapper<StopPlaceSignType>({
    ...
    [StopPlaceSignType.StopSign]: (t) =>
      t(($) => $.stopPlaceSignTypeEnum.StopSign),
    [StopPlaceSignType.CanopyFrame]: (t) =>
      t(($) => $.stopPlaceSignTypeEnum.CanopyFrame),
    [StopPlaceSignType.PoleSign]: (t) =>
      t(($) => $.stopPlaceSignTypeEnum.PoleSign),
    [StopPlaceSignType.JokerSign]: (t) =>
      t(($) => $.stopPlaceSignTypeEnum.JokerSign),
    [StopPlaceSignType.Minibuses]: (t) =>
      t(($) => $.stopPlaceSignTypeEnum.Minibuses),
  });
...
>({
  ...
  [StopRegistrySignContentType.Other]: (t) =>
    t(($) => $.signContentTypeEnum.other),
});
...
>({
  ...
  [StopRegistryStopType.BusBulb]: (t) =>
    t(($) => $.stopRegistryStopTypeEnum.busBulb),
  [StopRegistryStopType.InLane]: (t) =>
    t(($) => $.stopRegistryStopTypeEnum.inLane),
  [StopRegistryStopType.Other]: (t) =>
    t(($) => $.stopRegistryStopTypeEnum.other),
  [StopRegistryStopType.PullOut]: (t) =>
    t(($) => $.stopRegistryStopTypeEnum.pullOut),
});
...
>({
  ...
  [StopRegistryMapType.Tactile]: (t) =>
    t(($) => $.stopRegistryMapTypeEnum.tactile),
});
...
export const mapStopRegistryShelterElectricityEnumToUiName =
  genTranslationMapper<StopRegistryShelterElectricity | NullOptionEnum>({
    ...
    [StopRegistryShelterElectricity.ContinuousUnderConstruction]: (t) =>
      t(
        ($) => $.stopRegistryShelterElectricityEnum.continuousUnderConstruction,
      ),
...
>({
  ...
  [StopRegistryShelterType.Post]: (t) =>
    t(($) => $.stopRegistryShelterTypeEnum.post),
...
>({
  ...
  [RouteTypeOfLineEnum.FerryService]: (t) =>
    t(($) => $.lineTypeEnum.ferry_service),
  [RouteTypeOfLineEnum.MetroService]: (t) =>
    t(($) => $.lineTypeEnum.metro_service),
...
>(
  {
    [RouteDirectionEnum.Inbound]: (t) =>
      t(($) => $.directionEnum.symbol.inbound),
    [RouteDirectionEnum.Outbound]: (t) =>
      t(($) => $.directionEnum.symbol.outbound),
  },
  () => '?',
);
...
>(
  {
    [RouteDirectionEnum.Inbound]: (t) =>
      t(($) => $.directionEnum.label.inbound),
    [RouteDirectionEnum.Outbound]: (t) =>
      t(($) => $.directionEnum.label.outbound),
  },
...
>({
  [AllOptionEnum.All]: (t) => t(($) => $.all),
  [SubstituteDayOfWeek.NoTraffic]: (t) =>
    t(($) => $.timetableDayEnum.noTraffic),
  [SubstituteDayOfWeek.Monday]: (t) => t(($) => $.timetableDayEnum.monday),
  [SubstituteDayOfWeek.Tuesday]: (t) => t(($) => $.timetableDayEnum.tuesday),
  [SubstituteDayOfWeek.Wednesday]: (t) =>
    t(($) => $.timetableDayEnum.wednesday),
...
export const mapTerminalTypeToUiName = genTranslationMapper<TerminalType>({
  [TerminalType.RailwayStation]: (t) =>
    t(($) => $.terminalTypeEnum.railwayStation),
  [TerminalType.BusTerminal]: (t) => t(($) => $.terminalTypeEnum.busTerminal),
  [TerminalType.TramTerminal]: (t) => t(($) => $.terminalTypeEnum.tramTerminal),
  [TerminalType.MetroTerminal]: (t) =>
    t(($) => $.terminalTypeEnum.metroTerminal),
  [TerminalType.FerryTerminal]: (t) =>
    t(($) => $.terminalTypeEnum.ferryTerminal),
...
export const mapInfoSpotPurposeToUiName =
  genTranslationMapper<InfoSpotPurposeEnum>({
    [InfoSpotPurposeEnum.NULL]: (t) =>
      t(($) => $.stopDetails.infoSpots.purposes.null),
    [InfoSpotPurposeEnum.POSTER]: (t) =>
      t(($) => $.stopDetails.infoSpots.purposes.poster),
    [InfoSpotPurposeEnum.MAP]: (t) =>
      t(($) => $.stopDetails.infoSpots.purposes.map),
...
export const mapStopOwnerToUiName = genTranslationMapper<StopOwner>({
  ...
  [StopOwner.Hkl]: (t) =>
    t(($) => $.stopDetails.maintenance.stopOwnerOptions.hkl),
  [StopOwner.Hkr]: (t) =>
    t(($) => $.stopDetails.maintenance.stopOwnerOptions.hkr),
  [StopOwner.Vr]: (t) =>
    t(($) => $.stopDetails.maintenance.stopOwnerOptions.vr),
  [StopOwner.Ely]: (t) =>
    t(($) => $.stopDetails.maintenance.stopOwnerOptions.ely),
