...
export const useShowRoutesOnModal = () => {
  ...
  const showRouteInMapByLabel = (route: RouteInformationForMapFragment) => {
  ...
  const showRouteInMapByLineLabel = (line: LineInformationForMapFragment) => {
    const { latitude, longitude } = getRouteShapeFirstCoordinates(
  ...
  const showRouteInMapById = (route: RouteInformationForMapFragment) => {
    const { latitude, longitude } = getRouteShapeFirstCoordinates(
      route.route_shape,
    );
  ...
  return {
    showRouteInMapByLabel,
    showRouteInMapByLineLabel,
    showRouteInMapById,
  };
};
