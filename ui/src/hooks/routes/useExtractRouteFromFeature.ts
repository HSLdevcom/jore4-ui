...
interface SnapPointCalculateParams {
  isFirstLink: boolean;
  isLastLink: boolean;
  isLoopLink: boolean;
...
const getSnapPointCalculateParamsForInfraLink = (
  ...
  const isBidirectional =
    link.direction === InfrastructureNetworkDirectionEnum.Bidirectional;
  const isLongEnough = featureLength > MIN_INFRA_LINK_POINT_PICK_LENGTH;
