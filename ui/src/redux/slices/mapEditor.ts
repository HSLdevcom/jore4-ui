  ...
  reducers: {
    ...
    setDraftRouteGeometry: {
      reducer: (
        ...
        state.editedRouteData = {
          ...state.editedRouteData,
          includedStopLabels: Array.from(new Set(includedStopLabels)),
          stopsEligibleForJourneyPattern,
          infraLinks,
        };
      },
    ...
    setDraftRouteJourneyPatternStops: {
      reducer: (
        state: IState,
        action: PayloadAction<StoreType<JourneyPatternStopFragment>[]>,
      ) => {
        state.editedRouteData.journeyPatternStops = action.payload;
      },
      prepare: (payload: JourneyPatternStopFragment[]) => ({
        ...mapToStoreType({ payload }),
      }),
    },
    /**
