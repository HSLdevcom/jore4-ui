...
export const VehicleScheduleFrameBlocksView = ({
  ...
  const vehicleScheduleFrameBlocks = `${vehicleScheduleFrameLabel}Blocks`;
  return (
    <div data-testid={testIds.frameBlocks(vehicleScheduleFrameLabel)}>
        ...
        <Row className="flex-1 border border-l border-light-grey border-l-white bg-brand py-2 px-4">
          <Row className="flex-1 items-center justify-between font-normal">
            ...
            <AccordionButton
              ...
              controls={vehicleScheduleFrameBlocks}
            />
          </Row>
        </Row>
      </Row>
      ...
      <Visible visible={isOpen}>
        <div id={vehicleScheduleFrameBlocks} className="my-4 space-y-4">
          {blocks.map((block) => (
