...
import { VehicleJourneyDuplicate } from '../../../../hooks/timetables-import/deviations/duplicate-journeys';
import { VehicleJourneyRow } from './vehicle-journey-row';
      ...
      >
        <thead>
          <tr className="[&>th]:p-2 [&>th]:px-8 [&>th]:font-normal">
            <th className="">
              {t('timetablesPreview.duplicateJourneys.label')}
            </th>
            <th className="">
              {t('timetablesPreview.duplicateJourneys.departureTime')}
            </th>
            <th className="">
              {t('timetablesPreview.duplicateJourneys.dayType')}
            </th>
            <th className="!pr-0">
