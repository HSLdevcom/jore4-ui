...
import { StopAreaHeader } from '../../for-stop-areas/StopAreaHeader';
import { StopAreaSearchNoStops } from '../../for-stop-areas/StopAreaSearchNoStops';
import { TerminalHeader } from '../../for-terminals/TerminalHeader';
import { TerminalSearchNoStops } from '../../for-terminals/TerminalSearchNoStops';
  ...
  return (
    <div className={className}>
      ...
      <Visible visible={!loading && stops.length === 0}>
        {isTerminal ? (
          <TerminalSearchNoStops terminal={stopPlace} />
        ) : (
          <StopAreaSearchNoStops stopArea={stopPlace} />
        )}
      </Visible>
    </div>
  );
