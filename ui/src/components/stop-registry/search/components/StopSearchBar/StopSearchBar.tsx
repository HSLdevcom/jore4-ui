  ...
  return (
    ...
    <FormProvider {...methods}>
      ...
      >
        ...
        {!searchIsExpanded && (
          // For "Search on enter pressed" to work, there needs to be a submit
          // button on the form. The primary submit button is hidden under the
          // ExtraFilters section and thus not rendered on DOM. So, add an extra
          // hidden submit button to the form, when the ExtraFilters section is
          // closed.
