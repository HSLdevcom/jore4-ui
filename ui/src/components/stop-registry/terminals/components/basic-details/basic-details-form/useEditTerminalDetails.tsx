...
export const useUpsertTerminalDetails = () => {
  const { initializeTerminal, upsertTerminal, defaultErrorHandler } =
    useUpsertTerminal();

  const upsertTerminalDetails = useCallback(
