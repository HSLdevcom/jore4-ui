...
const testIds = {
  ...
  nameEng: 'TerminalDetailsEdit::nameEng',
  nameLongFin: 'TerminalDetailsEdit::nameLongFin',
  nameLongSwe: 'TerminalDetailsEdit::nameLongSwe',
  nameLongEng: 'TerminalDetailsEdit::nameLongEng',
  abbreviationFin: 'TerminalDetailsEdit::abbreviationFin',
  abbreviationSwe: 'TerminalDetailsEdit::abbreviationSwe',
  abbreviationEng: 'TerminalDetailsEdit::abbreviationEng',
...
> = ({ terminal, className = '', onFinishEditing, refetch }, ref) => {
