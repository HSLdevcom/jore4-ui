...
export default useInfoSpotFormDefaultValues;
...
const InfoSpotTitle: FC<{
  ...
  return (
    <h4>
      <span>
        { infoSpotCount ? t('stopDetails.infoSpots.title') : t('stopDetails.infoSpots.titleNoInfoSpots') } &nbsp;
      </span>
      <span className="font-normal">
        { 
          t('stopDetails.infoSpots.shelterTypeSubtitle', {
             index: shelterIndex + 1,
             shelterType: mapStopRegistryShelterTypeEnumToUiName(shelter.shelterType ?? NullOptionEnum.Null)
          })
        }
      </span>
    </h4>
...
export const InfoSpotsSection: FC<Props> = ({
  ...
  return (
    <InfoContainer
      ...
      title={<InfoSpotTitle infoSpotCount={infoSpotCount} shelter={shelter} shelterIndex={shelterIndex} />}
      testIdPrefix="InfoSpotsSection"
    >
