...
// JoreCombobox is not suitable here: it only supports string-typed values
// (this needs object values), hardcodes displayValue to empty string
// (this needs to show the selected area name), and has an incompatible
// input+button layout.
export const StopAreaSearchCombobox: FC<StopAreaSearchComboboxProps> = ({
  ...
  const { areas, loading: loadingAreas } = useFindStopAreas(
    query,
    vehicleMode,
  );
