...
function mapPlaceEquipmentsToInput(
  ...
  return {
    cycleStorageEquipment: equipments.cycleStorageEquipment,
    generalSign: equipments.generalSign?.map(mapGeneralSignToInput),
    sanitaryEquipment: equipments.sanitaryEquipment,
    shelterEquipment: equipments.shelterEquipment,
    ticketingEquipment: equipments.ticketingEquipment,
    waitingRoomEquipment: equipments.waitingRoomEquipment,
  };
}
