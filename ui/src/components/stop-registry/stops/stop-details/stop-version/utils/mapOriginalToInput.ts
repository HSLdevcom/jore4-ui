...
function mapMultilingualString(
...
function mapGeneralSignToInput(
  ...
  return {
    ...
    content: mapMultilingualString(generalSign.content),
    note: mapMultilingualString(generalSign.note),
...
function mapQuaysToInput(
  ...
  return mapCompactOrNull(quays, (quay) => ({
    ...
    name: mapMultilingualString(quay.name),
    description: mapMultilingualString(quay.description),
    shortName: mapMultilingualString(quay.shortName),
...
export function mapOriginalToInput(
  ...
  return {
    ...
    name: mapMultilingualString(stopPlace.name),
    description: mapMultilingualString(stopPlace.description),
    shortName: mapMultilingualString(stopPlace.shortName),
