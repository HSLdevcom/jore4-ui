...
const testIds = {
  container: 'MeasurementsFormComponent::container',
  stopType: 'MeasurementsFormComponent::stopType',
  curvedStop: 'MeasurementsFormComponent::curvedStop',
  shelterType: 'MeasurementsFormComponent::shelterType',
  shelterLaneDistance: 'MeasurementsFormComponent::shelterLaneDistance',
  curbBackOfRailDistance: 'MeasurementsFormComponent::curbBackOfRailDistance',
  stopAreaSideSlope: 'MeasurementsFormComponent::stopAreaSideSlope',
  stopAreaLengthwiseSlope: 'MeasurementsFormComponent::stopAreaLengthwiseSlope',
  structureLaneDistance: 'MeasurementsFormComponent::structureLaneDistance',
  stopElevationFromRailTop:
    'MeasurementsFormComponent::stopElevationFromRailTop',
  stopElevationFromSidewalk:
    'MeasurementsFormComponent::stopElevationFromSidewalk',
  lowerCleatHeight: 'MeasurementsFormComponent::lowerCleatHeight',
  curbDriveSideOfRailDistance:
    'MeasurementsFormComponent::curbDriveSideOfRailDistance',
  endRampSlope: 'MeasurementsFormComponent::endRampSlope',
  serviceAreaWidth: 'MeasurementsFormComponent::serviceAreaWidth',
  serviceAreaLength: 'MeasurementsFormComponent::serviceAreaLength',
  pedestrianCrossingRampType:
    'MeasurementsFormComponent::pedestrianCrossingRampType',
  stopAreaSurroundingsAccessible:
    'MeasurementsFormComponent::stopAreaSurroundingsAccessible',
  guidanceType: 'MeasurementsFormComponent::guidanceType',
  mapType: 'MeasurementsFormComponent::mapType',
  platformEdgeWarningArea: 'MeasurementsFormComponent::platformEdgeWarningArea',
  sidewalkAccessibleConnection:
    'MeasurementsFormComponent::sidewalkAccessibleConnection',
  guidanceStripe: 'MeasurementsFormComponent::guidanceStripe',
  serviceAreaStripes: 'MeasurementsFormComponent::serviceAreaStripes',
  guidanceTiles: 'MeasurementsFormComponent::guidanceTiles',
};
  ...
  return (
    ...
    <FormProvider {...methods}>
      ...
      >
        ...
        <Row className="shrink flex-wrap items-end gap-4 md:flex-nowrap">
          <InputField<MeasurementsFormState>
            type="number"
            translationPrefix="stopDetails.measurements"
            min={0}
