...
export function diffMeasurementDetails(
  ...
  const changes = [
    diffValues({
      ...
      mapper: mapOr((v) => mapStopRegistryStopTypeToUiName(t, v)),
    }),
    diffValues({
    ...
    diffValues({
      ...
      mapper: mapOr((v) => mapStopRegistryShelterWidthTypeToUiName(t, v)),
    }),
    ...
    diffValues({
      ...
      mapper: mapOr((v) => mapStopRegistryGuidanceTypeToUiName(t, v)),
    }),
    diffValues({
    ...
    diffValues({
      ...
      mapper: mapOr((v) => mapStopRegistryMapTypeToUiName(t, v)),
    }),
