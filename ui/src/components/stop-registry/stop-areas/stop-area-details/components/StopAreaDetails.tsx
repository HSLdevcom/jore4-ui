...
const testIds = {
  editButton: 'StopAreaDetailsPage::StopAreaDetails::editButton',
  name: 'StopAreaDetailsPage::StopAreaDetails::name',
  description: 'StopAreaDetailsPage::StopAreaDetails::description',
  parentStopPlace: 'StopAreaDetailsPage::StopAreaDetails::parentStopPlace',
  areaSize: 'StopAreaDetailsPage::StopAreaDetails::areaSize',
  validityPeriod: 'StopAreaDetailsPage::StopAreaDetails::validityPeriod',
};
...
export const StopAreaDetails: FC<StopAreaComponentProps> = ({
  ...
  return (
    <div className={twMerge('flex w-4/6 flex-col items-stretch', className)}>
      ...
      <DetailRow className="!mb-0 flex-grow rounded-b border border-t-0 px-4 py-2">
        <LabeledDetail
