...
function modalStateToDisplay(
  ...
  const currentVersion = trimEnd(
    `${mapToShortDate(modalState.currentVersion.start)} - ${mapToShortDate(modalState.currentVersion.end) ?? ''}`,
  );
  const newVersion = trimEnd(
    `${mapToShortDate(modalState.newVersion.start)} - ${mapToShortDate(modalState.newVersion.end) ?? ''}`,
  );
