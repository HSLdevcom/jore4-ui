...
import { useCopyStopAreaFormUtils } from './useCopyStopAreaFormUtils';
...
type CopyStopAreaFormProps = {
  ...
  readonly onCopyCreated: (result: CopyStopAreaResult) => void;
...
export const CopyStopAreaForm: FC<CopyStopAreaFormProps> = ({
  ...
  const { methods, onFormSubmit } = useCopyStopAreaFormUtils(
    stopArea,
    onCopyCreated,
  );
