...
type UseChooseTimingPlaceDropdownResult = {
  readonly timingPlaces: ReadonlyArray<TimingPlaceForComboboxFragment>;
  readonly selectedTimingPlace?: TimingPlaceForComboboxFragment;
};

export function useChooseTimingPlaceDropdown(
  query: string,
  timingPlaceId?: string,
): UseChooseTimingPlaceDropdownResult {
