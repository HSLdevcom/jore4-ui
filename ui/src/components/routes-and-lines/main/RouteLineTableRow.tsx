...
const yBorderClassnames = 'border-y border-light-grey';
...
export const RouteLineTableRow = ({
  ...
  return (
    <tr className={className}>
      ...
      <td
        className={`${alertStyle.listItemBorder} w-0 border-y p-0 align-top`}
      />
      <td className={`${yBorderClassnames} w-20 p-4`}>
        {alertStyle.icon && (
