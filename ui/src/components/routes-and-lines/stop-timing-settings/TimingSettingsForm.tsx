        ...
        <Row>
          ...
          >
            <input
              ...
              {...methods.register('isUsedAsTimingPoint', {})}
              className="mr-3.5 h-6 w-6"
              data-testid={testIds.isUsedAsTimingPoint}
        ...
        <Row>
          ...
          >
            <input
              ...
              {...methods.register('isRegulatedTimingPoint', {})}
              className="mr-3.5 h-6 w-6"
              data-testid={testIds.isRegulatedTimingPoint}
            />
        ...
        <Row>
          ...
          >
            <input
              ...
              {...methods.register('isLoadingTimeAllowed', {})}
              className="mr-3.5 h-6 w-6"
              data-testid={testIds.isLoadingTimeAllowed}
            />
