...
export function diffRouteDetails(
  ...
  return compact([
    ...
    diffKeyedValues({
      key: 'NameSv',
      field: t('lineChangeHistory.extraFields.routeNameSv'),
    ...
    diffKeyedValues({
      key: 'DescriptionFi',
      field: t('lineChangeHistory.extraFields.routeDescriptionFi'),
      oldValue: previous.description_i18n?.fi_FI,
      newValue: current.description_i18n?.fi_FI,
    }),
    diffKeyedValues({
      key: 'DescriptionSv',
      field: t('lineChangeHistory.extraFields.routeDescriptionSv'),
    ...
    diffKeyedValues({
      key: 'estimated_length_in_metres',
