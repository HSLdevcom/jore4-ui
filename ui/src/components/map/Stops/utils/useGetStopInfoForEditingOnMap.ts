...
function parseResult(
  ...
  const locationNames: ReadonlyArray<RawAlternativeName> = [
  ...
  const formState: ExistingStopFormState = {
    ...
    locationFin: findRawAlternativeName(locationNames, 'OTHER', 'fin'),
    locationSwe: findRawAlternativeName(locationNames, 'OTHER', 'swe'),
