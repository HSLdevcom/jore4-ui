...
export const Stop = ({
  ...
  return (
    <Marker
      ...
      draggable={draggable}
      onDragEnd={onDragEnd}
      className={`${testId} map:stopMarker rounded-full`} // the Marker component does not have testid property, neither does data-testid work, so have to use className
    >
      <Circle
