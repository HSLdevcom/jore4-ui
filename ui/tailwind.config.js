    ...
    extend: {
      ...
      colors: {
        ...
        border: {
          ...
          'hsl-speed-tram-turquoise': colors.border.hslSpeedTramTurquoise,
        ...
        'hsl-speed-tram-turquoise': colors.hslSpeedTramTurquoise,
        'hsl-ferry-blue': colors.hslFerryBlue,
        'hsl-metro-orange': colors.hslMetroOrange,
        'hsl-trunk-line-orange': colors.hslTrunkLineOrange,
      ...
      backgroundImage: {
        'welcome-gradient':
          'linear-gradient(180deg, rgba(255,255,255,0.5) 0%, rgba(0,115,190,0.5) 50%)',
      },
    },
  },
