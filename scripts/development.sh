...
function download_dump {
  ...
  read -p "Dump file name (default: jore4e2e-test-20230512-data-only-6dc421cb.pgdump): " DUMP_FILENAME
  DUMP_FILENAME="${DUMP_FILENAME:-jore4e2e-test-20230512-data-only-6dc421cb.pgdump}"
