...
do
  ...
  if test "$custom_image" != "$newest_image"; then
    echo -e "\033[31m$item\033[0m does not use newest image in custom.yml, uses \033[31m$custom_image\033[0m newest is \033[32m$newest_image\e0330m"
  fi
done
...
do
  ...
  if test "$e2e_image" != "$newest_image"; then
    echo -e "\033[31m$item\033[0m does not use newest image in e2e.yml, uses \033[31m$custom_image\033[0m newest is \033[32m$newest_image\e0330m"
  fi
done
