...
### Experiementing with pre-rendered tiles

For comparison we have also created possibility to experiement with pre-rendered vector routes.
...
1. show/hide routes served from martin
2. show/hide routes server from mbtileserver
