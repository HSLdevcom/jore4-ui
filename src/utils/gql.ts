 ...
 */
export const constructActiveDateFilterGql = (date?: DateTime | null) => ({
  _and: [
    {
      _or: [
 ...
 */
export const constructDraftPriorityFilterGql = (priority?: Priority) => ({
  priority: {
...
export const constructLabelFilterGql = (label?: string) => ({
  label: { _eq: label },
});
