...
export const StopActionsDropdown = ({
  ...
  const doesStopBelongToJourneyPattern = !!scheduledStopPointInJourneyPattern;
  ...
  return (
    ...
    >
      {doesStopBelongToJourneyPattern ? (
      ...
      {isViaPoint ? (
        ...
        <button
          disabled={!doesStopBelongToJourneyPattern}
          className={`${
            !doesStopBelongToJourneyPattern
              ? 'bg-background text-dark-grey'
              : ''
          }`}
          type="button"
