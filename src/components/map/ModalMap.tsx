...
import { selectSelectIsModalMapOpen } from '../../redux';
import { setIsOpenAction } from '../../redux/slices/modalMap';
...
export const ModalMap: React.FC<Props> = ({ className }) => {
  ...
  const isModalMapOpen = useAppSelector(selectSelectIsModalMapOpen);
