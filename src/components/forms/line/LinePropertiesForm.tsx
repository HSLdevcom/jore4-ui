...
const testIds = {
  transportTargetDropdown: 'linePropertiesForm:transportTargetDropdown',
  vehicleModeDropdown: 'linePropertiesForm:vehicleModeDropdown',
  lineTypeDropdown: 'linePropertiesForm:lineTypeDropdown',
};
interface Props {
  id?: string;
  className?: string;
