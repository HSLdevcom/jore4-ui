...
export const LanguageDropdown: FunctionComponent<Props> = ({
  ...
  // These are not translated on puprose. Now this seems to work like https://www.hsl.fi/ does.
        ...
        {({ open }) => (
          <>
            ...
            >
              <Menu.Items
                static
                className="absolute right-0 w-full origin-top-right bg-brand rounded-b-md shadow-md border-black border-opacity-20 focus:outline-none"
