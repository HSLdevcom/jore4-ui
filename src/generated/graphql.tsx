...
export type PatchScheduledStopPointViaInfoMutationVariables = Exact<{
  ...
  viaInfo: JourneyPatternScheduledStopPointInJourneyPatternSetInput;
}>;
...
export const PatchScheduledStopPointViaInfoDocument = gql`
    mutation PatchScheduledStopPointViaInfo($stopLabel: String!, $journeyPatternId: uuid!, $viaInfo: journey_pattern_scheduled_stop_point_in_journey_pattern_set_input!) {
