...
export type SearchAllLinesAndRoutesQueryVariables = Exact<{
...
export type SearchAllLinesAndRoutesQuery = { __typename?: 'query_root', route_line: Array<{ __typename?: 'route_line', line_id: UUID, label: string, name_i18n: LocalizedString, short_name_i18n: LocalizedString, validity_start?: luxon.DateTime | null | undefined, validity_end?: luxon.DateTime | null | undefined }>, route_route: Array<{ __typename?: 'route_route', route_id: UUID, name_i18n: LocalizedString, description_i18n?: LocalizedString | null | undefined, origin_name_i18n: LocalizedString, origin_short_name_i18n: LocalizedString, destination_name_i18n: LocalizedString, destination_short_name_i18n: LocalizedString, on_line_id: UUID, label: string, priority: number }> };
...
export const SearchAllLinesAndRoutesDocument = gql`
    query SearchAllLinesAndRoutes($lineFilter: route_line_bool_exp, $routeFilter: route_route_bool_exp, $lineOrderBy: [route_line_order_by!], $routeOrderBy: [route_route_order_by!]) {
...
/**
 * __useSearchAllLinesAndRoutesQuery__
 *
 * To run a query within a React component, call `useSearchAllLinesAndRoutesQuery` and pass it any options that fit your needs.
 * When your component renders, `useSearchAllLinesAndRoutesQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useSearchAllLinesAndRoutesQuery({
 *   variables: {
 ...
 * });
 */
export function useSearchAllLinesAndRoutesQuery(baseOptions?: Apollo.QueryHookOptions<SearchAllLinesAndRoutesQuery, SearchAllLinesAndRoutesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<SearchAllLinesAndRoutesQuery, SearchAllLinesAndRoutesQueryVariables>(SearchAllLinesAndRoutesDocument, options);
      }
export function useSearchAllLinesAndRoutesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<SearchAllLinesAndRoutesQuery, SearchAllLinesAndRoutesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<SearchAllLinesAndRoutesQuery, SearchAllLinesAndRoutesQueryVariables>(SearchAllLinesAndRoutesDocument, options);
        }
export type SearchAllLinesAndRoutesQueryHookResult = ReturnType<typeof useSearchAllLinesAndRoutesQuery>;
export type SearchAllLinesAndRoutesLazyQueryHookResult = ReturnType<typeof useSearchAllLinesAndRoutesLazyQuery>;
export type SearchAllLinesAndRoutesQueryResult = Apollo.QueryResult<SearchAllLinesAndRoutesQuery, SearchAllLinesAndRoutesQueryVariables>;
...
export function useSearchAllLinesAndRoutesAsyncQuery() {
          return useAsyncQuery<SearchAllLinesAndRoutesQuery, SearchAllLinesAndRoutesQueryVariables>(SearchAllLinesAndRoutesDocument);
        }
export type SearchAllLinesAndRoutesAsyncQueryHookResult = ReturnType<typeof useSearchAllLinesAndRoutesAsyncQuery>;
