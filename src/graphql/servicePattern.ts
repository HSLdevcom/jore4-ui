...
`;
export const mapGetStopResult = (result: GqlQueryResult<GetStopByIdQuery>) =>
...
const GET_STOP_ROUTES_BY_ID = gql`
...
export const mapGetStopRoutesByIdResult = (
  result: GqlQueryResult<GetStopRoutesByIdQuery>,
) =>
  result.data?.service_pattern_scheduled_stop_point?.[0] as
    | ServicePatternScheduledStopPoint
    | undefined;
