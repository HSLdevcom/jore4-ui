...
describe('Timetable validity period', () => {
  ...
  it(
    ...
    () => {
      ...
      vehicleScheduleDetailsPage.routeTimetableList.routeTimetablesSection
        .getRouteTimetableSection('99', 'inbound')
      ...
      vehicleScheduleDetailsPage.routeTimetablesSection
        .getRouteTimetableSection('99', 'inbound')
        .within(() => {
          vehicleScheduleDetailsPage.routeTimetablesSection.vehicleServiceTable
            .getTable('LA')
            .within(() => {
              vehicleScheduleDetailsPage.vehicleJourneyGroupInfo
