...
describe('Timetable validity period', () => {
  ...
  it(
    ...
    () => {
      ...
      vehicleScheduleDetailsPage.routeTimetableList.routeTimetablesSection.vehicleServiceTable.getHeadingButton(
        'Lauantai',
      );
      vehicleScheduleDetailsPage.vehicleJourneyGroupInfo
      ...
      vehicleScheduleDetailsPage.vehicleJourneyGroupInfo.verifyTripTimeRange(
        '07:10',
        '08:20',
      );
