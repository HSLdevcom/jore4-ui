...
describe(
  ...
  () => {
    ...
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    it('Searches line with asterisk', { tags: tags.lines }, () => {
    ...
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    it('Searches route with exact ID', { tags: tags.lines }, () => {
      routesAndLinesPage
        .getRoutesAndLinesSearchInput()
    ...
    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
    // @ts-ignore
    it('Searches route with asterisk', { tags: tags.lines }, () => {
      routesAndLinesPage.getRoutesAndLinesSearchInput().type('1*{enter}');
      cy.wait('@gqlSearchLinesAndRoutes');
      searchResultsPage
        .getSearchResultsContainer()
