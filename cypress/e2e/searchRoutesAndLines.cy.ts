...
const lines: LineInsertInput[] = [
  // Valid in 2022
  {
    ...
    validity_start: DateTime.fromISO('2022-01-02T22:00:00+00:00'),
    validity_end: DateTime.fromISO('2022-12-24T22:00:00+00:00'),
  },
  // Valid in 2023
  {
    ...buildLine({ label: '2666' }),
    line_id: '61e4d95e-34e5-11ed-a261-0242ac120002',
    validity_start: DateTime.fromISO('2023-01-02T22:00:00+00:00'),
    validity_end: DateTime.fromISO('2023-12-24T22:00:00+00:00'),
  },
  // Valid in 2024
  {
    ...buildLine({ label: '1777' }),
    line_id: '47c5fe92-e630-430b-a2da-2c6739acbb2b',
    validity_start: DateTime.fromISO('2024-01-02T22:00:00+00:00'),
    validity_end: DateTime.fromISO('2024-12-24T22:00:00+00:00'),
  },
  // The rest are valid between 2000 and 2054
  {
    ...buildLine({ label: '9999' }),
    line_id: '7f5aa870-891a-433e-bd9b-f864162a2adf',
    validity_start: DateTime.fromISO('2000-01-02T22:00:00+00:00'),
    validity_end: DateTime.fromISO('2054-12-24T22:00:00+00:00'),
  },
  {
...
describe(
  ...
  () => {
    ...
    it(
      'Shows valid results according to the observation date',
      ...
      () => {
        ...
        searchResultsPage
          .getLinesSearchResultTable()
          // Line 1777 is valid in 2024 and the other two are not
          .should('contain', '1777')
