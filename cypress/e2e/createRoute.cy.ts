...
describe('Route creation', () => {
  ...
  it(
    ...
    () => {
      ...
      modalMap.routeStopsOverlay.routeShouldExist(routeName);
      ...
      routeStopsTable.getEditRouteButton(routeName).click();

      modalMap.routePropertiesForm.verifyRouteFormInfo(routeInfo);
    },
  );
