...
const testCoordinates1 = [24.92492146851626, 60.1634759878872, 0];
const testCoordinates2 = [24.92904198486008, 60.16490775039894, 0];
const testCoordinates3 = [24.932072417514647, 60.166003223527824, 0];
...
const stops: StopInsertInput[] = [
  {
    ...buildStop({
      label: 'Test stop 1',
      located_on_infrastructure_link_id: '73bc2df9-f5af-4c38-a1dd-5ed1f71c90a8',
    }),
  ...
  },
  {
    ...buildStop({
      label: 'Test stop 2',
      located_on_infrastructure_link_id: 'ea69415a-9c54-4327-8836-f38b36d8fa99',
    }),
    validity_start: DateTime.fromISO('2020-03-20T22:00:00+00:00'),
  ...
  },
  {
    ...buildStop({
      label: 'Test stop 3',
      located_on_infrastructure_link_id: '13de61c2-3fc9-4255-955f-0a2350c389e1',
    }),
    validity_start: DateTime.fromISO('2020-03-20T22:00:00+00:00'),
    scheduled_stop_point_id: '6c09b8d9-5952-4ee3-92b9-a7b4847517d3',
    measured_location: {
      type: 'Point',
      coordinates: testCoordinates3,
    },
  },
];
...
describe('Route creation', () => {
  ...
  beforeEach(() => {
    ...
    const mapLocation = [24.929689228090112, 60.16495016651525];
