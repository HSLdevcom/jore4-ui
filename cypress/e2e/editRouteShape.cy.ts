...
import {
  ...
  buildTestStopsOnTestInfraLinks,
  testInfraLinkExternalIds,
} from '../datasets/basedataset';
...
describe('Edit route geometry', () => {
  ...
  before(() => {
    cy.task<UUID[]>(
      ...
      const stops = buildTestStopsOnTestInfraLinks(infraLinkIds);
  ...
  beforeEach(() => {
    deleteRoutesByLabel(['Test route 2']);
  ...
  it(
    ...
    () => {
      ...
      routeStopsOverlay.routeShouldBeSelected('Test route 1');
    ...
    () => {
      ...
      mapModal.createRoute({
        routeFormInfo: {
          ...
          validityStartISODate: '2022-08-11T13:08:43.315+03:00',
          validityEndISODate: '2032-08-11T13:08:43.315+03:00',
          priority: Priority.Standard,
        },
      });
      ...
      routeStopsOverlay.routeShouldBeSelected('Test route 2');
