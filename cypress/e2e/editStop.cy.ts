...
describe('Stop editing tests', () => {
  ...
  it('should warn if StopPlace save succeeds but Stop Point fails', () => {
    ...
    toast.expectDangerToast(
      'Pysäkkien tiedot on päivitty pysäkkirekisteriin, mutta niiden vienti linjastoon epäonnistui! Tallennusta on syytä yrittää uudelleen! Syy: Response not successful: Received status code 500',
    );
  });
});
