...
describe('Stop editing tests', () => {
  ...
  beforeEach(() => {
    ...
    map.visit({
      zoom: 15,
      lat: testCoordinates1[1],
      lng: testCoordinates1[0],
    });
  });
  ...
  it(
    ...
    () => {
      ...
      const endCoordinates = [24.92410607697449, 60.16321976836281];
  ...
  it(
    ...
    () => {
      ...
      const updatedStopInfo: StopFormInfo = {
        ...
        latitude: String(testCoordinates2[1]),
        longitude: String(testCoordinates2[0]),
      };
      ...
      stopForm.getLatitudeInput().should('have.value', testCoordinates2[1]);
      stopForm.getLongitudeInput().should('have.value', testCoordinates2[0]);
    },
  );
});
