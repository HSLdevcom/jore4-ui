...
import { ConfirmSaveForm, Map, StopForm } from '../pageObjects';
...
const testStopLabels = {
  ...
  timingPlaceStopLabel: 'Timing place stop label',
};
...
describe('Stop creation tests', () => {
  ...
  it(
    ...
    () => {
      ...
      modalMap.createStopAtLocation({
        stopFormInfo: {
          label: testStopLabels.timingPlaceStopLabel,
      ...
      cy.getByTestId(
        `Map::Stops::stopMarker::${testStopLabels.timingPlaceStopLabel}_Standard`,
      ).click();
