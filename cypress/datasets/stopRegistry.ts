...
const stopPlaceData: Array<StopAreaInput> = [
  {
    StopArea: {
      ...
      keyValues: [
        { key: KeyValueKeysEnum.ValidityStart, values: ['2020-01-01'] },
        { key: KeyValueKeysEnum.ValidityEnd, values: ['2050-01-01'] },
      ],
      geometry: {
      ...
      quays: [
        {
          ...
          keyValues: [
            { key: KeyValueKeysEnum.StreetAddress, values: ['Annankatu 15'] },
            { key: KeyValueKeysEnum.ElyNumber, values: ['E2E001'] },
          ],
        ...
        },
        {
          ...
          keyValues: [
            { key: KeyValueKeysEnum.StreetAddress, values: ['Annankatu 15'] },
            { key: KeyValueKeysEnum.ElyNumber, values: ['E2E009'] },
          ],
          geometry: coordinatesToStopRegistryGeoJSON(
      ...
      quays: [
        {
          publicCode: 'E2E003',
          keyValues: [
            { key: KeyValueKeysEnum.StreetAddress, values: ['Kalevankatu 32'] },
      ...
      quays: [
        {
          ...
          keyValues: [
            { key: KeyValueKeysEnum.StreetAddress, values: ['Annankatu 20'] },
            { key: KeyValueKeysEnum.ElyNumber, values: ['E2E002'] },
          ],
        },
      ],
      ...
      quays: [
        {
          ...
          keyValues: [
            ...
            { key: KeyValueKeysEnum.ElyNumber, values: ['E2E004'] },
          ],
        },
      ],
      ...
      quays: [
        {
          ...
          keyValues: [
            ...
            { key: KeyValueKeysEnum.ElyNumber, values: ['E2E005'] },
          ],
        },
      ],
      ...
      quays: [
        {
          ...
          keyValues: [
            { key: KeyValueKeysEnum.StreetAddress, values: ['Kalevankatu 18'] },
            { key: KeyValueKeysEnum.ElyNumber, values: ['E2E007'] },
            { key: KeyValueKeysEnum.ValidityStart, values: ['2020-03-20'] },
          ],
        },
      ],
      ...
      quays: [
        {
          ...
          keyValues: [
            ...
            { key: KeyValueKeysEnum.ElyNumber, values: ['E2E008'] },
            { key: KeyValueKeysEnum.ValidityStart, values: ['2020-03-20'] },
          ],
          placeEquipments: {
            generalSign: [
      ...
      quays: [
        {
          ...
          keyValues: [
            { key: KeyValueKeysEnum.StreetAddress, values: ['Finnoonkartano'] },
            { key: KeyValueKeysEnum.ElyNumber, values: ['E2E010'] },
            { key: KeyValueKeysEnum.ValidityStart, values: ['2020-03-20'] },
          ],
        },
      ],
      ...
      quays: [
        {
          ...
          keyValues: [
            ...
            { key: KeyValueKeysEnum.ElyNumber, values: ['E2E011'] },
            { key: KeyValueKeysEnum.ValidityStart, values: ['2020-01-01'] },
            { key: KeyValueKeysEnum.ValidityEnd, values: ['2052-01-01'] },
          ],
          geometry: coordinatesToStopRegistryGeoJSON(
...
const terminalData: Array<TerminalInput> = [
  {
    terminal: {
      ...
      keyValues: [
        ...
        { key: KeyValueKeysEnum.PostalCode, values: ['00100'] },
        { key: KeyValueKeysEnum.Municipality, values: ['Helsinki'] },
        { key: KeyValueKeysEnum.FareZone, values: ['A'] },
        { key: KeyValueKeysEnum.TerminalType, values: ['BusTerminal'] },
        { key: KeyValueKeysEnum.DeparturePlatforms, values: ['7'] },
        { key: KeyValueKeysEnum.ArrivalPlatforms, values: ['6'] },
        { key: KeyValueKeysEnum.LoadingPlatforms, values: ['3'] },
        { key: KeyValueKeysEnum.ElectricCharging, values: ['2'] },
      ],
      externalLinks: [
        {
