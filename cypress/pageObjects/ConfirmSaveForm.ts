export class ConfirmSaveForm {
  setAsStandard(forceAction = false) {
    return cy
      .getByTestId('confirmSaveForm:standardPriorityButton')
      .click({ force: forceAction });
  }

  setAsDraft(forceAction = false) {
    return cy
      .getByTestId('confirmSaveForm:draftPriorityButton')
      .click({ force: forceAction });
  }

  setAsTemporary(forceAction = false) {
    return cy
      .getByTestId('confirmSaveForm:temporaryPriorityButton')
      .click({ force: forceAction });
  }
  ...
  setStartDate(isoDate: string, forceAction = false) {
    return cy
      ...
      .type(isoDate, { force: forceAction });
  }
