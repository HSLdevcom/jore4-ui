const openMapTilesIndexResponse = {
  basename: 'finland.mbtiles',
  id: 'openmaptiles',
  filesize: '1607503872',
  tilejson: '2.0.0',
  pixel_scale: '256',
  ...
  bounds: [18.9832098, 57.3541578, 31.6867044, 70.1922939],
  center: [25.3, 63.8, 1],
  minzoom: 0,
  maxzoom: 14,
  attribution:
...
export function mockMapTileServerReponses() {
  ...
  cy.intercept('https://hslstoragestatic.azureedge.net/mapfonts/*', {
    statusCode: 404,
    body: 'Request blocked in tests!',
  }).as('block-map-fonts');
