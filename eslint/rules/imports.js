module.exports = {
  rules: {
    ...
    // Reports the use of import declarations with CommonJS exports in any module except for the master module.
    ...
    // 'import-x/no-default-export' rule is also turned on, so they cannot even have
    // default exports.
